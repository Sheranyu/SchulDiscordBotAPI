...
public partial class PostgresContext : DbContext
{
    ...
    public virtual DbSet<MemeName> MemeNames { get; set; }
    ...
    public virtual DbSet<SchulBotConfig> SchulBotConfigs { get; set; }
    ...
    public virtual DbSet<TextInhalt> TextInhalts { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MemeName>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("meme_names_pkey");

            entity.ToTable("meme_names");

            entity.HasIndex(e => e.Name, "meme_names_name_key").IsUnique();
        ...
        modelBuilder.Entity<SchulBotConfig>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("BotConfig_pkey");

            entity.ToTable("SchulBotConfig");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnName("created_at");
            entity.Property(e => e.GetRandomMeme).HasDefaultValue(false);
            entity.Property(e => e.Messagelisten).HasColumnName("messagelisten");
            entity.Property(e => e.UserId).HasColumnName("User_id");

            entity.HasOne(d => d.User).WithMany(p => p.SchulBotConfigs)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("SchulBotConfig_User_id_fkey");
        });
        ...
        modelBuilder.Entity<TextInhalt>(entity =>
        {
            entity.HasKey(e => e.IdText).HasName("text_inhalt_pkey");

            entity.ToTable("text_inhalt");

            entity.Property(e => e.IdText).HasColumnName("id_text");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnName("created_at");
            entity.Property(e => e.NamesId).HasColumnName("names_id");
            entity.Property(e => e.Text).HasColumnName("text");

            entity.HasOne(d => d.Names).WithMany(p => p.TextInhalts)
                .HasForeignKey(d => d.NamesId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("text_inhalt_names_id_fkey");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.Authtoken }).HasName("User_pkey");

            entity.ToTable("User");

            entity.HasIndex(e => e.Authtoken, "User_authtoken_key").IsUnique();
            ...
            entity.Property(e => e.Id)
                .ValueGeneratedOnAdd()
                .HasColumnName("id");
            entity.Property(e => e.Authtoken).HasColumnName("authtoken");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnName("created_at");
            entity.Property(e => e.Name)
